                            ...
                            <div className="filter-bar__section__option">
                                ...
                                <div className="radio-button radio-button--horizontal">
                                    <div className="radio-button__option active  ">
                                        <input type="radio" className="radio-button__input" value="ONLY_FOR_TWO" id="applicantNumber-ONLY_FOR_TWO" name="applicantNumber" data-option-default="false" data-tracking-item="Gemeinschaftskonto - Value: Ja" checked="checked" />
